...
def test_enter_profile(driver):
    ...
    WebDriverWait(driver, 3).until(expected_conditions.url_to_be(consts.SITE_PROFILE_URL))
    assert driver.current_url == consts.SITE_PROFILE_URL
